...
export const ROUTES = {
  ...
  bibleBooks: { method: METHOD.GET, path: '/desktop/bible/books' },
  bibleChapters: { method: METHOD.GET, path: '/desktop/bible/chapters' },
  bibleVerses: { method: METHOD.GET, path: '/desktop/bible/verses' },
